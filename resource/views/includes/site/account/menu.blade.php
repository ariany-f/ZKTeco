<ul class="menu-content">
    ...
    <a href="{{ route('site.myaccount.client') }}" title="Seus dados pessoais"><li><i class="fa fa-user"></i> Dados Pessoais</li></a>
    <a href="{{ route('site.cart') }}" title="Orçamento em andamento"><li><i class="fa fa-shopping-cart"></i> Orçamento em andamento</li></a>
